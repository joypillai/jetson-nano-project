...
net=jetson.inference.imageNet('alexnet',['--model=/home/jetbot/Downloads/jetson-inference/python/training/classification/myModel2/resnet18.onnx','--input_blob=input_0','--output_blob=output_0','--labels=/home/jetbot/Downloads/jetson-inference/myTrain2/label.txt'])
